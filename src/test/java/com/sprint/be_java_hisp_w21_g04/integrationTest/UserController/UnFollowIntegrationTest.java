...
public class UnFollowIntegrationTest {
    ...
    private String url = "/users/{userId}/unfollow/{userIdToUnfollow}";
    @Autowired
    MockMvc mockMvc;
    ...
    @Test
    void unfollowTestIntegrationOk() throws Exception {
        // Arrange
        ResponseDto expectResponseDto = new ResponseDto("Has dejado de seguir a " + "EmilyDavis" );
        String reponseJson = writer.writeValueAsString(expectResponseDto);

        MockHttpServletRequestBuilder request = MockMvcRequestBuilders.post( url, 5, 4);
    ...
    @Test
    void UserNotFollowedTestIntegration() throws Exception {
        // Arrange
    ...
    @Test
    void userUnfollowNotAllowedTestIntegration() throws Exception {
        // Arrange
